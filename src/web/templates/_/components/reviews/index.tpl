          ...
          <div class="shadow p-3 p-md-5">
            <div class="row">
              <div class="col-12 col-md-2">
                <img class="reviews__img" src="{{$_my.templateUrlBase}}images/base/review.png" alt="Фото клиента">
              </div>
      ...
      <div class="row">
        <div class="col p-4">
          <div class="shadow p-3 p-md-5">
            <div class="row">
              <div class="col-12 col-md-2">
                <img class="reviews__img" src="{{$_my.templateUrlBase}}images/base/review-02.png" alt="Фото клиента">
              </div>
              <div class="col-12 col-md-10">
      ...
      <div class="row">
        <div class="col p-4">
          <div class="shadow p-3 p-md-5">
            <div class="row">
              <div class="col-12 col-md-2">
                <img class="reviews__img" src="{{$_my.templateUrlBase}}images/base/review-03.png" alt="Фото клиента">
              </div>
              <div class="col-12 col-md-10">
      ...
      <div class="row">
        <div class="col p-4">
          <div class="shadow p-3 p-md-5">
            <div class="row">
              <div class="col-12 col-md-2">
                <img class="reviews__img" src="{{$_my.templateUrlBase}}images/base/review-04.png" alt="Фото клиента">
              </div>
              <div class="col-12 col-md-10">
