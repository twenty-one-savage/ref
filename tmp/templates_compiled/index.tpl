...
<!--<![endif]-->
    ...
    <body id="top" class=" mode_development">
    ...
    <div class="container-fluid section-padding fill fill_gray-light">
        <div class="row">
            <div class="col-12 col-xl-10 offset-xl-1">
                <!-- _/components/partners/index.tpl -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-lg-10 offset-lg-1">
            <!-- _/components/benefit/index.tpl -->
<section id="benefit" class="benefit fill fill_primary-light section-padding">
  <h2 class="benefit__title title title_section">Какую выгоду вы можете получить</h2>
  <div class="row">
    <div class="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2">
      <div class="row mb-4">
        <div class="col-12 col-md-4">
          <div class="benefit__wrapper">
            <div class="benefit__number">7,8</div>
            <div class="benefit__value benefit__value_percent">%</div>
          </div>
          <p class="text-center text-md-left">новая ставка рефинансирования</p>
        </div>
        <div class="col-12 col-md-4">
          <div class="benefit__wrapper">
        ...
        <div class="col-12 col-md-4">
          <div class="benefit__wrapper">
            <div class="benefit__value">на</div>
            <div class="benefit__number ml-3">4</div>
            <div class="benefit__value">года</div>
          </div>
          <p class="text-center text-md-left">в среднем сокращается срок выплаты кредита</p>
        </div>
      </div>
      <div class="row">
...
<!-- /// _/components/steps/index.tpl -->
    ...
    <div class="fill fill_gray-light section-padding">
        <div class="container section-padding">
            <div class="row">
                <div class="col-12">
                    <!-- _/components/reviews/index.tpl -->
<section id="reviews" class="reviews">
  <h2 class="reviews__title title title_section">Сколько сэкономили наши клиенты</h2>
...
<!-- /// _/components/reviews/index.tpl -->
    ...
    <div class="container section-padding">
        <div class="row">
            <div class="col-12">
                <!-- _/components/features/index.tpl -->
<section id="features" class="features">
  <h2 class="features__title title title_section">Наши преимущества</h2>
  <div class="row">
    <div class="col-12 col-md-6 mb-3 mb-md-4">
      <div class="row">
        <div class="col-auto">
          <div class="features__decorate">
            <i class="i i_icon-percent i_size_45 text-primary"></i>
          </div>
        </div>
        <div class="col">
          <h3 class="features__subtitle">Самая низкая ставка</h3>
          <p class="features__text">Подберем для вас самые выгодные предложения банков по рефинансированию</p>
        </div>
      </div>
    </div>
    <div class="col-12 col-md-6 mb-3 mb-md-4">
      <div class="row">
        <div class="col-auto">
          <div class="features__decorate">
            <i class="i i_icon-wallet i_size_45 text-primary"></i>
          </div>
        </div>
        <div class="col">
    ...
    <div class="col-12 col-md-6 mb-3 mb-md-4">
      <div class="row">
        <div class="col-auto">
          <div class="features__decorate">
            <i class="i i_icon-support i_size_45 text-primary"></i>
          </div>
        </div>
        <div class="col">
    ...
    <div class="col-12 col-md-6 mb-3 mb-md-4">
      <div class="row">
        <div class="col-auto">
          <div class="features__decorate">
            <i class="i i_icon-paperplane i_size_40 text-primary"></i>
          </div>
        </div>
        <div class="col">
...
<!-- /// _/sections/footer.tpl -->
        ...
        <!-- _/components/modals/mod1.tpl -->
<section class="popup fill fill_primary-light" id="popup1" style="display: none;">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <div class="p-3 p-md-4 p-lg-5">
          ...
          <form action="">
            ...
            <div class="row mt-3 mt-md-5">
              <div class="col-12 text-center">
                <button class="popup__btn btn btn-primary" type="submit">Рассчитать выгоду</button>
              </div>
            </div>
          </form>
        </div>
...
<!-- /// _/components/modals/mod1.tpl -->
        ...
        <!-- _/components/modals/mod2.tpl -->
<section class="popup fill fill_primary-light" id="popup2" style="display: none;">
<div class="container">
  <div class="row">
    <div class="col-12">
      <div class="p-3 p-md-4 p-lg-5">
          <h2 class="popup__title title title_section">Рассчитайте выгоду рефинансирования</h2>
          <p class="popup__text">Введите свой номер телефона, и мы пришлем вам рассчет выгоды в WhatsApp</p>
          <form action="">
            <label class="popup__label">
              <span>Ваш номер телефона</span>
              <input class="popup__input mt-2" type="tel" placeholder="+7 xxx xxx-xx-xx" required>
            </label>
...
<section class="popup fill fill_primary-light" id="popup3" style="display: none;">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <div class="p-3 p-md-4 p-lg-5">
          <p class="popup__text mb-0">Спасибо!</p>
          <p class="popup__text">В ближайшее время вы получите персональный расчет экономики в WhatsApp.</p>
        </div>
      </div>
    </div>
  </div>
...
<!-- /// _/components/quiz/quiz.tpl -->
            ...
            <script src="assets/js/vendors.js?ver=1"></script>
            <script src="assets/js/scripts.js?ver=1"></script>
        <script><!-- _/sections/js/main.js.tpl -->


<!-- /// _/sections/js/main.js.tpl -->
</script>
